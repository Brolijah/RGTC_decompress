...
function RGTC:decompressRGTC2_to_RGBA(file_in, w, h, tbl_swiz)
	assert(FileSystem.existsSync(file_in, "Input texture file doesn't exist!!"))
	...
	local X, Y, Z = {}, {}, {}
	local workingBuff = Buffer:new(FileSystem.readFileSync(file_in))
